...
```{r}
logit_model_MNAR <- glm(dropout ~ Course + Admission_grade + Curricular_units_Sem2_grade +	Unemployment_rate +	Inflation_rate + GDP + Gender
...
We will attempt to recover the data using MICE to re-imput the missing nulls.
```{r}
...
.
```{r}
logit_model_imputed <- glm(dropout ~  Course + Admission_grade + Curricular_units_Sem2_grade +	Unemployment_rate +	Inflation_rate + GDP + Gender
