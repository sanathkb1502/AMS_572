...
```{r}
sprintf("mean = %f", mean(data$Previous_qualification_grade)) 
sprintf("standard deviation = %f", sd(data$Previous_qualification_grade))
```
...
```{r}
sprintf("mean = %f", mean(data$Admission_grade)) 
sprintf("standard deviation = %f", sd(data$Admission_grade))
```
...
```{r}
sprintf("mean of grades in Semester-1= %f", mean(data$Curricular_units_Sem1_grade))
sprintf("standard deviation  of grades in Semester-1 = %f", sd(data$Curricular_units_Sem1_grade))
sprintf("mean  of grades in Semester-2 = %f", mean(data$Curricular_units_Sem2_grade)) 
sprintf("standard deviation  of grades in Semester-2 = %f", sd(data$Curricular_units_Sem2_grade))
```
...
mosaicplot(color = TRUE, gender_target_table, main = "Mosaic Plot of Gender and Target", 
...
mosaicplot(color = TRUE, marital_target_table, main = "Mosaic Plot of Marital Status and Target",
...
```{r}
attend_target_table <- table(data$Attendance, data$Target)
mosaicplot(color = TRUE, attend_target_table, main = "Mosaic Plot of Attendance and Target", xlab = "Attendance", ylab = "Target")
```
...
mosaicplot(color = TRUE, debtor_target_table, main = "Mosaic Plot of Debtor and Target", 
...
mosaicplot(color = TRUE, scholar_target_table, main = "Mosaic Plot of Scholarhip Holder and Target", 
...
```{r}
ggplot(data, aes(x = Curricular_units_Sem1_grade, y = Curricular_units_Sem2_grade,
                 color = Target)) +
